...
- Create: `.apptlas/policies/definition-of-done.md`
...
- [ ] **Step 4: Write `.apptlas/policies/definition-of-done.md`**
...
git commit -m "docs: add agent operating layer (.apptlas), AGENTS.md contract, DoD policy"
```
